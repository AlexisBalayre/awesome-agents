...
Orgs, experts, and repos to monitor for new agent tools, frameworks, and research. The **`source-monitor`** agent reads this file and reports what's new; the **`list-curator`** agent turns surfaced candidates into verified entries. Update `Last checked` after each monitoring run.
